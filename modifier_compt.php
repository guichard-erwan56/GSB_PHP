...
<body>
	...
	<div id="fiche2">
		...
		<form id="block1" action="index.php" method="post">
			<u>Modification</u></b><br> <br> Sélectionner un mois : <SELECT
				name="mois" size="1">
			...
			<?php Foreach ($list_modifier_compt as $list_modifier_compt): ?>
			
			<option value=<?php echo $list_modifier_compt['id']; ?>>
								<?php echo $list_modifier_compt['nom']; ?></option>
